...
class Cell:
    def __init__(self, _cell_count):
        self._cell_count = _cell_count
    def __str__(self):
    ...
    def __sub__(self, other):
        sub  = self._cell_count - other._cell_count
        return [sub if sub > 0 else print('Вычитание невозможно')]
    ...
    def make_order(self, cells_in_row):
        row = ''
        for i in range(self._cell_count // cells_in_row):
            row += '*' * cells_in_row + '\n'
        row += '*' * self._cell_count % cells_in_row + '\n'
        return print(row)
